rule_dict = {
    ...
    "Fun-declaration-prime": [["#dec-func", "(", "Params", ")", "#param-info", "Compound-stmt", "#end-func"]],
    "Type-specifier": [["int"], ["void"]],
    "Params": [["#save-in-ss", "int", "#save-in-ss", "ID", "Param-prime", "Param-list"], ["void"]],
    "Param-list": [[",", "Param", "Param-list"], ['epsilon']],
    "Param": [["Declaration-initial", "Param-prime"]],
    "Param-prime": [["[", "]", "#dec-pointer"], ['epsilon', "#dec-var"]],
    ...
    "Var-call-prime": [["(", "#start-args", "Args", ")", "#check-args"], ["Var-prime"]],
    "Var-prime": [["[", "Expression", "]", "#calc-arr-addr"], ['epsilon']],
    "Factor-prime": [["(", "#start-args", "Args", ")", "#check-args"], ['epsilon']],
